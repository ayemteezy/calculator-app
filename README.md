...
<h3 align="center">project_title</h3>
  ...
  <p align="center">
    project_description
    <br />
    <a href="https://github.com/ayemteezy/repo_name"><strong>Explore the docs »</strong></a>
    <br />
    <br />
    <a href="https://github.com/ayemteezy/repo_name">View Demo</a>
    &middot;
    <a href="https://github.com/ayemteezy/repo_name/issues/new?labels=bug&template=bug-report.md">Report Bug</a>
    &middot;
    <a href="https://github.com/ayemteezy/repo_name/issues/new?labels=enhancement&template=feature-request.md">Request Feature</a>
  </p>
</div>
...
Here's a blank template to get started. To avoid retyping too much info, do a search and replace with your text editor for the following: `ayemteezy`, `repo_name`, `twitter_handle`, `linkedin_username`, `email_client`, `email`, `project_title`, `project_description`, `project_license`
...
2. Clone the repo
   ```sh
   git clone https://github.com/ayemteezy/repo_name.git
   ```
...
5. Change git remote url to avoid accidental pushes to base project
   ```sh
   git remote set-url origin ayemteezy/repo_name
...
See the [open issues](https://github.com/ayemteezy/repo_name/issues) for a full list of proposed features (and known issues).
...
<a href="https://github.com/ayemteezy/repo_name/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=ayemteezy/repo_name" alt="contrib.rocks image" />
</a>
